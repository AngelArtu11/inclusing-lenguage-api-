...
namespace InclusingLenguage.API.Services
{
    public interface IMongoDBService
    {
        ...
        IMongoCollection<Progresion> Progresion { get; }
        IMongoCollection<Nivel> Niveles { get; }
    ...
    public class MongoDBService : IMongoDBService
    {
        ...
        public IMongoCollection<UserProfile> Users =>
            _database.GetCollection<UserProfile>("Usuarios");

        public IMongoCollection<Progresion> Progresion =>
            _database.GetCollection<Progresion>("Progresion");

        public IMongoCollection<Nivel> Niveles =>
            _database.GetCollection<Nivel>("Niveles");
